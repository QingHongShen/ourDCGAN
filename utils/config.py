...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='mnist', choices=['mnist', 'fashion-mnist', '308', 'cifar', 'stl10'],
...
def check_args(args):
    ...
    if args.dataset == 'cifar' or args.dataset == 'stl10' or args.dataset == '308':
        args.channels = 3
    else:
        args.channels = 1
